...
describe("model picker", () => {
  ...
  it("disables thinking mode for models without advertised variants", () => {
    document.body.innerHTML = `
      <form><div><input name="model_selection" value="openai/gpt-4o"><input name="model_variant" value=""><div data-model-picker><span data-model-picker-label></span><img data-model-picker-logo><span data-model-picker-default-badge></span><button type="button" data-model-picker-option data-value="openai/gpt-4o" data-label="GPT-4o"></button><div data-model-picker-variant-area><div data-model-picker-variant-unavailable><select disabled data-model-picker-variant-unavailable-select><option value="">default</option></select></div></div></div></div></form>
    `;
  ...
  it("can commit a modal selection without submitting its form", () => {
    document.body.innerHTML = `
      <form><div><input name="model_selection" value=""><input name="model_variant" value=""><div data-model-picker><button type="button" data-model-picker-open></button><span data-model-picker-label></span><img data-model-picker-logo><span data-model-picker-default-badge></span><div class="hidden" data-model-picker-modal><button type="button" data-model-picker-option data-provider-id="openai" data-value="openai/gpt-4o" data-label="GPT-4o"></button><button type="button" data-model-picker-save></button></div></div></div></form>
    `;
