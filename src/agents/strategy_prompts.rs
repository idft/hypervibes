...
use crate::{
    agents::prompts::{
        DEFAULT_ANALYSIS_STRATEGY_PROMPT, DEFAULT_CODING_STRATEGY_PROMPT,
        DEFAULT_REVIEW_STRATEGY_PROMPT, DEFAULT_TRADING_STRATEGY_PROMPT,
    },
    db::DbPool,
    harness::model::{
...
pub fn default_prompt_for_role(sub_agent_kind: &str) -> &'static str {
    match sub_agent_kind {
        ...
        SUB_AGENT_KIND_CODING => DEFAULT_CODING_STRATEGY_PROMPT,
